			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 42 Hai Bà Trưng Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0379617865</a></li>
					</ul>
				</div>
						...
						<div class="cart">
							...
							@foreach($productCart as $product)
								...
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="upload/product/{{$product['item']['Hinh']}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">{{$product['item']['Name']}}</span>
										
											<span class="cart-item-amount">{{$product['qty']}} X <span>
												@if($product['item']['GiaKM']==0){{number_format($product['item']['DonViGia'])}}
												@else {{number_format($product['item']['GiaKM'])}}
												@endif
								...
								<div class="cart-caption">
									...
									{{ number_format(Session('cart')->totalPrice) }} VND</span></div>
									<div class="clearfix"></div>
